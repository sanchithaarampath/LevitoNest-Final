...
var R, V = "undefined" != typeof window ? import_react.useLayoutEffect : import_react.useEffect, $ = function() {
	...
	return import_react.createElement(re, u({}, r, { colorModel: te }));
}, oe = {
	defaultColor: {
		h: 0,
		s: 0,
	...
	return import_react.createElement(re, u({}, r, { colorModel: oe }));
}, le = {
	...
	return import_react.createElement(re, u({}, r, { colorModel: le }));
}, ce = {
	defaultColor: {
		h: 0,
		s: 0,
	...
	return import_react.createElement(U, u({}, r, { colorModel: ce }));
}, se = {
	...
	return import_react.createElement(U, u({}, r, { colorModel: se }));
}, ve = {
	defaultColor: {
		h: 0,
		s: 0,
	...
	return import_react.createElement(re, u({}, r, { colorModel: ve }));
}, he = {
	...
	return import_react.createElement(re, u({}, r, { colorModel: he }));
}, ge = {
	defaultColor: {
		h: 0,
		s: 0,
	...
	return import_react.createElement(U, u({}, r, { colorModel: ge }));
}, be = {
	...
	return import_react.createElement(U, u({}, r, { colorModel: be }));
}, xe = {
	defaultColor: {
		r: 0,
		g: 0,
	...
	return import_react.createElement(U, u({}, r, { colorModel: we }));
	...
	var t = r.color, l = void 0 === t ? "" : t, s = r.onChange, f = r.onBlur, v = r.escape, d = r.validate, h = r.format, m = r.process, g = c(r, [
		...
		"format",
		"process"
	]), p = (0, import_react.useState)(function() {
		return v(l);
	}), b = p[0], _ = p[1], x = i(s), C = i(f), E = (0, import_react.useCallback)(function(e) {
	...
	return (0, import_react.useEffect)(function() {
		_(v(l));
	}, [l, v]), import_react.createElement("input", u({}, g, {
		value: h ? h(b) : b,
		spellCheck: "false",
		onChange: E,
		onBlur: H
	...
	var t = r.prefixed, n = r.alpha, o = c(r, ["prefixed", "alpha"]), l = (0, import_react.useCallback)(function(e) {
		return e.replace(/([^0-9A-F]+)/gi, "").substring(0, n ? 8 : 6);
	}, [n]), i = (0, import_react.useCallback)(function(e) {
		return function(e, r) {
			var t = qe.exec(e), n = t ? t[1].length : 0;
			return 3 === n || 6 === n || !!r && 4 === n || !!r && 8 === n;
		}(e, n);
	}, [n]);
	return import_react.createElement(ke, u({}, o, {
		escape: l,
		format: t ? Ie : void 0,
		process: Ie,
		validate: i
